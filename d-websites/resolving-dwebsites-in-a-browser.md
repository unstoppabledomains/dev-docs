...
In order to set up a redirection to a traditional domain, you will need to do a redirection via `index.html` on your NFT domain so users are sent to a traditional domain.

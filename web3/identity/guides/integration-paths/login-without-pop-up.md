...
First, you will configure the UAuth class using the [Client Metadata](/web3/identity/guides/client-configurations.md#client-metadata) from your login client configuration.
...
The redirect URIs used to configure this `UAuth` instance must be an **EXACT** match to the [Redirect URIs](/web3/identity/guides/client-configurations.md#redirect-uris) entered in your [Login Client Configuration](/web3/identity/guides/client-configurations.md). See [Rules for Redirect URIs](/web3/identity/guides/client-configurations.md#rules-for-redirect-uris) for more details.

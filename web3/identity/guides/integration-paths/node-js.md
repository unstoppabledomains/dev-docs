...
Add `http://localhost:5000/callback` to your client's [Redirect URIs](/web3/identity/guides/client-configurations.md#redirect-uris). Make sure that the port matches the port your app is being served to. Example code in this guide assumes port 5000.

Set the [Token Endpoint Authentication Method](/web3/identity/guides/client-configurations.md#token-endpoint-authentication-method) on your client dashboard to **Client Secret Post**. Once you've clicked the **Confirm Changes** button, `clientSecret` and `clientAuthMethod` will be added to your client metadata on the **Basic** configuration page.
...
{% partial file="/web3/_partials/_login-paths-next.md" /%}

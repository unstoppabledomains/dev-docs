...
See [Rules for Redirect URIs](/web3/identity/guides/client-configurations.md#rules-for-redirect-uris) for more details on valid redirect URIs.
...
To resolve this, make sure that the **redirect URI** in your [client configuration](/web3/identity/guides/client-configurations.md) is at same origin as the application hosting the login flow.

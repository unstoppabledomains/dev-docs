...
| `scope`            | The profile information your application will be requesting from the user. In addition to the minimum scope of `openid wallet`, applications can request additional [scopes](/web3/identity/guides/login-scopes.md) by adding more tokens to this string in their UAuth configuration options. |

...
Calls the [loginCallback()](/web3/identity/sdk-and-libraries/uauth-js.md#logincallback) method of [this.uauth](#uauth) and activates the connector using the activate argument.
...
If `shouldLoginWithRedirect` is set to `true`, the [uauthConnector](#uauthconnector) instance will use the [login()](/web3/identity/sdk-and-libraries/uauth-js.md#login) method instead of the default, [loginWithPopup()](/web3/identity/sdk-and-libraries/uauth-js.md#loginwithpopup).

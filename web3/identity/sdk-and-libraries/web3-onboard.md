...
If `shouldLoginWithRedirect` is set to `true`, the [uauthModule](#uauthmodule) instance will use the [uauth.login()](/web3/identity/sdk-and-libraries/uauth-js.md#login) method instead of the default, [uauth.loginWithPopup()](/web3/identity/sdk-and-libraries/uauth-js.md#loginwithpopup).

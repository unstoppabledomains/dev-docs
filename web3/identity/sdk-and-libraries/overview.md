...
| ------------------------------------------------------------- | ------------- | ------------------------------------- |
| [UAuth JS](/web3/identity/sdk-and-libraries/uauth-js.md)     | `@uauth/js`   | SDK used for single-page applications |
| [UAuth Node](/web3/identity/sdk-and-libraries/uauth-node.md) | `@uauth/node` | SDK used server-side applications     |
...
| Reference                                                               | Package               | Description                       |
| ----------------------------------------------------------------------- | --------------------- | --------------------------------- |
| [Web3-React](/web3/identity/sdk-and-libraries/web3-react.md)     | `@uauth/web3-react`   | Middleware library for Web3-React |
| [Web3-Onboard](/web3/identity/sdk-and-libraries/web3-onboard.md) | `@web3-onboard/uauth` | UAuth Module for Web3-Onboard     |

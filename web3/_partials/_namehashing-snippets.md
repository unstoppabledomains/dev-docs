You can generate the [namehash](/web3/getting-started/glossary.md#namehash) of a domain using the [Resolution Service](/web3/apis/resolution/openapi#operation/DomainsController.getDomain). You can also use [online tools](https://swolfeyes.github.io/ethereum-namehash-calculator/) to calculate the namehash of the domain.

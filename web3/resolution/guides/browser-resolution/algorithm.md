...
![Diagram shows how to Resolve DWeb by direct read from Ethereum](/images/resolve_dweb_website_by_direct_reading_from_ethereum_and_decentralized_network.png "#width=75%")
...
![Process diagram depicting entire browser resolution algorithm](/images/browser_resolution_algorithm.svg "#width=75%")
...
To retrieve records associated with a domain, see [Resolve Using Smart Contracts](/web3/smart-contracts/quick-start/resolve-domains.md).
...
A recommended way to display content in a browser for Web3 domains is explained in [Resolve Domains in Web Applications](overview.md).
...
See [Resolve Domains in Web Applications](overview.md) for information on how to interpret those records.

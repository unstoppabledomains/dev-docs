...
For our HTTP-based API that allows you to quickly build applications that fetch UD domain data from the blockchain with a single API request, see the [Resolution Service API](/web3/apis/resolution/openapi). The Unstoppable Domains team manages this service.

- [Resolution](/web3/resolution/quickstart/resolution.md)
...
- [Resolve Using Smart Contracts](/web3/smart-contracts/quick-start/resolve-domains.md)
- [CNS Smart Contracts reference](/web3/smart-contracts/contract-reference/cns-smart-contracts.md)
- [UNS Smart Contracts reference](/web3/smart-contracts/contract-reference/uns-smart-contracts.md)
- [Records reference](/web3/resolution/records-reference.md)

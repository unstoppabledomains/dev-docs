...
Is our HTTP-based API that allows you to quickly build applications that fetch UD domain data from the blockchain with a single API request, see the [Resolution API](/web3/apis/resolution/openapi). The Unstoppable Domains team manages this service.

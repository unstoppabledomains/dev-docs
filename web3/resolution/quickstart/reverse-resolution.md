...
This page details basic configuration and usage of the [Resolution Service API](/web3/apis/resolution/openapi) to retrieve the reverse record(s) of UD domains.

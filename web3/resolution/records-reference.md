...
Developers may also set custom records for the domains. Domain records are stored as a key-value dictionary by domains and are not validated on the smart-contract level. For more details, read [CNS Architecture](/web3/smart-contracts/overview/cns-architecture-overview.md), [UNS Architecture](/web3/smart-contracts/overview/uns-architecture-overview.md), and [Managing Domain Records](/web3/smart-contracts/quick-start/manage-domain-records.md).
...
See [example](/web3/resolution/quickstart/resolution/#resolve-wallet-addresses) for how to resolve the address format
...
Browser resolution is described in the [Browser Resolution Algorithm](/web3/resolution/guides/browser-resolution/algorithm.md) page.
...
For more details, read [Browser Resolution Algorithm - DWeb Records](/web3/resolution/guides/browser-resolution/algorithm.md#decentralized-web-records).
...
For more details, see [Browser Resolution Algorithm - DNS Records](/web3/resolution/guides/browser-resolution/algorithm.md#dns-records).

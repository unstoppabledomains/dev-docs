...
The [UNS Registry](/web3/smart-contracts/contract-reference/uns-smart-contracts.md#unsregistry) smart contract is where domain owners store their data and is a map of domain namehashes to key-value dictionaries of records. Choose one of the Unstoppable Registry smart contracts to interact with below. 
...
{% admonition type="info"%}
Please see the [Record Reference](/web3/resolution/records-reference.md) guide and [reference JSON](https://github.com/unstoppabledomains/uns/blob/main/resolver-keys.json) file for all the resolver keys used by the Unstoppable Domains UNS Registry.
{% /admonition %}

## Step 5: Generate the Namehash of the Domain

{% partial file="/web3/_partials/_namehashing-snippets.md" /%}

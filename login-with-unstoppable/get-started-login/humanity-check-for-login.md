...
![Persona UI for uploading government ID](../../images/persona_upload_photo_id.png '#display=inline-block;padding=5px;width=20%;') ![Persona UI for uploading live photos or selfies](../../images/persona_live_photo_capture.png '#display=inline-block;padding=5px;width=20%;') ![Persona UI after identity verification is complete](../../images/persona_congratuations.png '#display=inline-block;padding=5px;width=20%;')
